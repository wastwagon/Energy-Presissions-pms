...
const DEFAULTS: PageDefaultsMap = {
  ...
  global: {
    footer: {
      ...
      tagline:
        'We provide turnkey solar solutions, from design, installation, and commissioning to monitoring and maintenance.',
      ...
      newsletter_text: 'Get exclusive news & offers through our Energy Precision newsletter',
